...
> 阅读此章前假设已经理解 JavaScript 的 [事件循环机制](https://yyt520.github.io/JavaScript-Guidebook/core-modules/executable-code-and-execution-contexts/concurrency-model/event-loop.html)
